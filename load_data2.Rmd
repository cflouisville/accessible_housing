...
![](interim_data/plots/dis_by_type.png)

## Demographics

### Sex

```{r sex_chart, eval = FALSE}
...
![](interim_data/plots/dis_by_sex.png)

### Race

```{r race_chart, eval = FALSE}
  #clean table
...
![](interim_data/plots/dis_by_race.png) 

### Income (Household level)

```{r income_chart, eval = FALSE}
...
![](interim_data/plots/dis_by_income.png)

### Age

```{r age_chart, eval = FALSE}
...
![](interim_data/plots/dis_by_age.png)
