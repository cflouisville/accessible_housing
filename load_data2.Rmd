...
Below is a graph showing the number of accessible units in various housing developments provided by KHC. The total number of housing units in the data set was 35,862, making the largest category of accessible units (all categories combined) about 3.59% of units. 
*Note: The differences in unit features based on categories ADA compliant, Physical Disabilities, and Special Needs have not yet been defined.*
...
plot_summary <- ggplot(summary_df, aes(x = Category, y = Units)) +
  ...
  geom_text(
    ...
    color = "darkblue",           # match bar color
