...
colors <- colorRampPalette(c("#ffe6eb", "#ed1e24"))(4)
...
colors <- colorRampPalette(c("#ffe6eb", "#ed1e24"))(6)
...
plot_summary <- ggplot(summary_df, aes(x = Category, y = Units)) +
  geom_col(fill = "#f9aebf", width = 0.5) +
  geom_text(
    aes(label = Units),
