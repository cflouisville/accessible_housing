...
plotmap <- ggplot(dis_map) +
  geom_sf(aes(fill = ambulatory_dis), color = "white", linewidth = 0.3) +
  ...
  theme_void() +
  theme(
    plot.title = element_text(hjust = 0.5, size = 22, face = "bold", family = "Montserrat"),
    legend.position = "right",
    legend.text = element_text(hjust = 1, family = "Montserrat"),
