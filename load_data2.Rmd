...
rm(household_dis_physical, household_dis_independent, household_dis_selfcare, household_dis_vision,
   household_dis_hearing, household_dis_cognitive, household_dis_any)
...
#cleanup
rm(income_and_any, income_and_hearing, income_and_independent, income_and_physical, income_and_selfcare, income_and_cognitive, income_and_vision)
...
hh_homeownership_dis_hearing     <- survey_by_demog(disability_data_hh, "dis_hearing", "HHWT", 
                                                    other_grouping_vars = "homeownership")
hh_homeownership_dis_cognitive   <- survey_by_demog(disability_data_hh, "dis_cognitive", "HHWT", 
                                                    other_grouping_vars = "homeownership")
...
rm(hh_homeownership_dis_physical, hh_homeownership_dis_independent, 
   ...
   hh_homeownership_dis_cognitive, hh_homeownership_dis_hearing, hh_homeownership_dis_any)
...
hh_income_dis_hearing     <- survey_by_demog(disability_data_hh, "dis_hearing", "HHWT", 
                                             other_grouping_vars = "income_group")
hh_income_dis_cognitive   <- survey_by_demog(disability_data_hh, "dis_cognitive", "HHWT", 
                                             other_grouping_vars = "income_group")
...
rm(hh_income_dis_physical, hh_income_dis_independent, 
   ...
   hh_income_dis_cognitive, hh_income_dis_hearing, hh_income_dis_any)
...
rm(age_and_any, age_and_hearing, age_and_independent, age_and_physical, age_and_cognitive, age_and_selfcare, age_and_vision)
...
HH_prev <- household_dis %>%
  ...
  pivot_longer(cols = c(any_dis_physical, any_dis_independent, any_dis_selfcare, any_dis_vision, any_dis_cognitive, any_dis_hearing, any_dis_any),
...
dis_by_sex <- individual_dis %>%
  ...
  pivot_longer(cols = c(dis_physical, dis_independent, dis_selfcare, dis_vision, dis_hearing, dis_cognitive, dis_any),
               names_to = "Disability_Type", 
               values_to = "Percent")%>%
